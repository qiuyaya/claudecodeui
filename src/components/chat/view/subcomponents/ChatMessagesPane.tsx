...
function ChatMessagesPane({
  ...
  const Header = useCallback(() => (
    <div className="space-y-3 px-0 py-3 sm:space-y-4 sm:px-4 sm:pt-4">
    ...
    isLoadingMoreMessages, isLoadingAllMessages, allMessagesLoaded,
    hasMoreMessages, totalMessages, sessionMessagesCount,
    showLoadAllOverlay, loadAllJustFinished,
    chatMessages.length, visibleMessageCount,
    loadEarlierMessages, loadAllMessages, t,
  ]);

  const Footer = useCallback(() => (
    <div className="px-0 pb-3 sm:px-4 sm:pb-4">
  ...
  return (
    ...
    >
      {isLoadingSessionMessages && chatMessages.length === 0 ? (
        <div className="flex-1 overflow-y-auto px-0 py-3 sm:p-4">
        ...
        <Virtuoso
          ...
          overscan={200}
          computeItemKey={(index, item) => getMessageKey(item)}
          components={{
            Header,
            Footer,
          }}
