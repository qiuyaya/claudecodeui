...
router.get('/git-config', authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.post('/git-config', authenticateToken, async (req: Request, res: Response) => {
  try {
    const userId = (req as AuthRequest).user!.id;
...
router.post('/complete-onboarding', authenticateToken, async (req: Request, res: Response) => {
  try {
    const userId = (req as AuthRequest).user!.id;
