 ...
 *
 * @returns Authentication status with { authenticated, email, method }
 ...
 */
async function checkClaudeCredentials(): Promise<AuthStatus> {
...
function checkCursorStatus(): Promise<AuthStatus> {
...
async function checkCodexCredentials(): Promise<AuthStatus> {
  try {
...
async function checkGeminiCredentials(): Promise<AuthStatus> {
