 ...
 */
function sanitizeError(error: AppError, isProduction: boolean): SanitizedError {
 ...
 */
export const errorHandler = (err: AppError, req: AuthRequest, res: Response, next: NextFunction): void => {
